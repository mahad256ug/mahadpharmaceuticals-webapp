...
export const metadata: Metadata = {
  ...
  description:
    "Get in touch with Mahad Pharmaceuticals — your trusted online pharmacy for affordable medicines, health products, and prescription support. Contact us for fast order assistance, delivery inquiries, pharmacy consultations, and expert healthcare advice. Reach us by phone, email, or live chat for reliable pharmaceutical services across Uganda and beyond.",
  keywords:
