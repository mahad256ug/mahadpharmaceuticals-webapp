...
export const metadata: Metadata = {
  ...
  keywords:
    "online pharmacy UAE, women's health, family planning, contraceptives, reproductive care, health drugs, online consultation, cash on delivery pharmacy, Mahad Pharmaceuticals",
  icons: {
    icon: [
