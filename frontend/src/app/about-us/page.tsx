...
export const metadata: Metadata = {
  title: "About Us",
  keywords:
    "about Mahad Pharmaceuticals, online pharmacy UAE, buy medicine UAE, women's health UAE, family planning UAE, contraceptives, wellness supplements, healthcare drugs UAE, online consultation UAE, pharmacy cash on delivery UAE, Dubai pharmacy online, trusted pharmacy UAE about us who we are",
  description:
